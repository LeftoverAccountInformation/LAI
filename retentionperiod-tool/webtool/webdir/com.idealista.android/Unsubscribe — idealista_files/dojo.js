	...
	dojo.parser = new function () {
		...
		this.instantiate = function (_16, _17, _18) {
			...
			d.forEach(_16, function (_1a) {
				...
				var _1c = _7(_1b),
					_1d = _1c.cls,
					ps = _1d._noScript || _1d.prototype._noScript;
				var _1e = {},
					_1f = _1a.attributes;
				...
				if (!ps) {
					...
					d.query("> script[type^='dojo/']", _1a).orphan().forEach(function (_26) {
						var _27 = _26.getAttribute("event"),
							_1b = _26.getAttribute("type"),
							nf = d.parser._functionFromScript(_26);
						if (_27) {
							if (_1b == "dojo/connect") {
								_24.push({
									event: _27,
...
if (!dojo._hasResource["dojo.string"]) {
	...
	dojo.string.pad = function (_4, _5, ch, _6) {
		...
		var _7 = String(_4),
			_8 = dojo.string.rep(ch, Math.ceil((_5 - _7.length) / ch.length));
	...
	dojo.number._parseInfo = function (_27) {
		...
		var re = dojo.regexp.buildGroupRE(_2f, function (_30) {
			...
			return _30.replace(dojo.number._numberPatternRE, function (_31) {
				var _32 = {
					signed: false,
					separator: _27.strict ? _2b : [_2b, ""],
					fractional: _27.fractional,
					decimal: _2c,
					exponent: false
				};
				var _33 = _31.split(".");
...
if('ca,de,en,es,fr,it,pt'.indexOf(_b) === -1) {
_b = dojo.attr(dojo.query('html')[0], 'env') || 'es';
}
return _b;
};
...
var loc=_2a[j]||"ROOT";
if (loc!=="ROOT") {var _2b=_28(loc);} //eliminamos la carga de las traducciones base (mjimenez).
if(_2b){
break;
}
}
