...
(m?m+",":"")+(n?n:"");p?(e.mmInitCallback=function(a){a(h,p,c)},D("MM.PRUH",a.baseContentUrl+"utils/pruh.js")):c()}})(a);return this}({
    ...
    afterResponse: function (getParam,
        setParam,
        genInfo) {
        ...
        function
        captureVisitorIdToWindow(crossDomainParams) {
            ...
            if (window.JSON &&
                ...
                for (i =
                    ...
                    cgParamValue
                        =
                        getParam(cgParamName,
                            0);

                    if (typeof cgParamValue ===
                        'undefined' || cgParamValue ===
                        'undefined') {
                ...
                if (hasCrossDomainParams) {
                    ...
                    window.name =
                        window.name.replace(/\|\*mm(.*)mm\*\|/,'') + ('|*mm' +JSON.stringify(crossDomainData) +'mm*|');
                }
    ...
    afterResponseExecution: function (
        getParam,
        setParam,
        genInfo) {
        /* custom code placeholder */
