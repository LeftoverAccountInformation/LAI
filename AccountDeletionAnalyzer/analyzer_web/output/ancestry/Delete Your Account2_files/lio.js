...
window['ly_cid'] = "6578caa0cdaa8dfcd95d5e6d3de12cc8";
...
(function(d, w, getIdResponse) {
  ...
  w.lio = {
    account: {
      id: "6578caa0cdaa8dfcd95d5e6d3de12cc8"
    },
    loaded: false,
    ...
    fields: !!w.liosetup && w.liosetup.fields || "behavior_last_acomapp_user,behavior_last_deny_geo_date,behavior_last_dnaapp_user,behavior_last_record_deny,behavior_last_records_access,behavior_last_search_deny_military,behavior_last_search_deny_newspapers,behavior_total_records_viewed,count_deny_pages,count_search_pages,dna_last_activated,dna_last_ordered,dna_last_results_ready,dna_results_linked_to_tree,dna_total_orders,do_not_email,hint_count_records,lastvisit_ts,subscription_has_fold3com,subscription_has_newspaperscom,subscription_last_cancel,subscription_trial_first_start,tree_last_modified_date,tree_last_node_created_date,tree_user_tree_count,tree_has_tree,behavior_is_current_trialer,behavior_is_current_subscriber,behavior_is_registrant,registration_date,tao" || "",
    stream: (w.liosetup && w.liosetup.stream) || (w.jstag && w.jstag.config && w.jstag.config.stream) || "default",
    data: {},
    personalize: {},
    blacklist:["gtm","tealium"],
    ...
    integrationsConfig:{
      ...
      googleAdsIntegration: [{"web_property":"","segments_dimension":"","user_id_dimension":""},{"web_property":"UA-60272843-1","segments_dimension":"dimension10","user_id_dimension":"dimension9"}],
...
if(typeof window.jstag !== 'object'){
    ...
    initObj.cid = "6578caa0cdaa8dfcd95d5e6d3de12cc8";
